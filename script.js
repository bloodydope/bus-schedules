document.addEventListener('DOMContentLoaded', function() {
    // Обновленные данные расписания с правильными интервалами
    const scheduleData = [
        { 
            route: "51", 
    ...
    // Функция для разделения времени по периодам
    ...
    function createHourButtons() {
        ...
        // Добавляем кнопки для каждого часа (6:00-23:00)
        for (let i = 6; i <= 23; i++) {
    ...
    // Заполнение таблицы данными с разделением по рейсам
    ...
    // Инициализация - показать все
    document.querySelector('.time-btn[data-time="all"]').classList.add('active');
    filterSchedule(); // Первоначальная фильтрация
});